...
const RBY: {[name: string]: MoveData} = {
  ...
  Clamp: {bp: 70, type: 'Water'},
  'Comet Punch': {bp: 20, type: 'Fighting', multihit: [2, 5]},
  Constrict: {bp: 45, type: 'Normal'},
  ...
  Fissure: {bp: 100, type: 'Ground'},
  Fly: {bp: 70, type: 'Flying'},
  'Focus Energy': {bp: 0, category: 'Status', type: 'Normal'},
  'Fury Attack': {bp: 20, type: 'Flying', multihit: [2, 5]},
  ...
  'Take Down': {bp: 90, type: 'Fighting', recoil: [1, 4]},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Sweet Scent': {bp: 45, category: 'Special', type: 'Fairy'},
  ...
  'False Swipe': {bp: 85, type: 'Normal'},
  'Flame Wheel': {bp: 60, type: 'Fire'},
  'Iron Tail': {bp: 95, type: 'Steel'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Astonish: {bp: 45, type: 'Ghost', makesContact: true},
  ...
  'Poison Tail': {bp: 55, type: 'Poison', makesContact: true},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Outrage: {bp: 75, category: 'Physical'},
  ...
  Gravity: {bp: 60, type: 'Fairy', category: 'Special'},
  'Head Smash': {
    bp: 150,
    type: 'Rock',
    recoil: [1, 2],
  ...
  'Lunar Dance': {bp: 200, type: 'Fairy', category: 'Special'},
  ...
  'Stealth Rock': {bp: 40, type: 'Rock', category: 'Physical'},
  'Sucker Punch': {
    bp: 80,
    type: 'Dark',
    priority: 1,
